module "dev_compute_1" {
  ...
  amis = {
    // aws ec2 describe-images --image-ids ami-04505e74c0741db8d --region us-east-1 
    us-east-1 = "ami-04505e74c0741db8d" # ubuntu 20.04 LTS
    //aws ec2 describe-images --image-ids ami-04505e74c0741db90 --region us-east-2   
...
module "dev_iam_1" {
  source              = "../../modules/iam"
  environment         = module.dev_vpc_1.environment
  rolename            = "CloudHBRole"
  instanceprofilename = "CloudHBinstprofile"
}